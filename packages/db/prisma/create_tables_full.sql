...
DO $$ BEGIN
  CREATE TYPE "AuditAction" AS ENUM ('TASK_CREATED', 'TASK_UPDATED', 'TASK_SUBMITTED', 'TASK_APPROVED', 'TASK_REJECTED', 'TASK_CHANGES_REQUESTED', 'REVIEW_STARTED', 'REVIEW_SUBMITTED');
EXCEPTION
  WHEN duplicate_object THEN null;
END $$;
